...
(function () {
  ...
  if (typeof window !== 'undefined' && window.location && window.location.protocol === 'file:') {
    container.innerHTML = '<p class="empty-state">Events load from JSON and require a web server. Run <code>npx serve site</code> or <code>python3 -m http.server 8000</code> from the project root (with site as cwd) and open the URL.</p>';
    return;
  }
